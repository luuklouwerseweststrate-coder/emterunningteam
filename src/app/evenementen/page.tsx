        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <p className="mt-6 max-w-2xl text-lg text-emte-gray-200">
              Van lokale bosloopjes tot grote stadsmarathons — het EMTE Running
              Team is overal te vinden. Bekijk waar je ons kunt tegenkomen en
              sluit je aan!
            </p>
          </AnimatedSection>
        </div>
          ...
          <AnimatedSection>
            <div className="rounded-2xl bg-emte-green p-10 text-center lg:p-16">
              ...
              <p className="mx-auto mt-4 max-w-xl text-lg text-emte-gray-200">
                Samen trainen, samen reizen, samen finishen. Sluit je aan bij
                het EMTE Running Team en maak van elke wedstrijd een
                teambelevenis.
              </p>
